...
Segment.prototype.useDefault = function () {
  this
    ...
    .loadDict('univercity.txt')    //扩展-中国前400所大学  PorYoung
    .loadDict('middlehighschool.txt')     //扩展-中国前100所高中  PorYoung
    .loadDict('wildcard.txt', 'WILDCARD', true)   // 通配符
    .loadSynonymDict('synonym.txt')   // 同义词    //增加高校简称 数字汉字对应   PorYoung
